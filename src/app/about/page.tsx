...
const values = [
  { icon: "🔍", title: "โปร่งใส", description: "อธิบายความคุ้มครองชัดเจน ไม่ซ่อนเงื่อนไข ให้ข้อมูลที่เป็นประโยชน์จริง" },
  { icon: "💡", title: "เข้าใจง่าย", description: "แปลงเรื่องซับซ้อนเกี่ยวกับประกันให้เข้าใจได้โดยไม่ต้องมีความรู้เฉพาะทาง" },
  { icon: "🤝", title: "ตั้งใจดูแล", description: "ให้คำแนะนำที่เหมาะสมกับสถานการณ์ของแต่ละคน ไม่ใช่แค่ขายแผน" },
  ...
  return (
    <>
      ...
      <section className="bg-white py-16">
        <Container size="prose">
          <div className="prose-thai">
            <h2>จุดยืนของเรา</h2>
            <p>
              <strong>Pragunpai เป็นที่ปรึกษาและผู้เปรียบเทียบแผนประกันภัย</strong>
      ...
      <section className="bg-navy-50 py-16">
        <Container size="wide">
          <SectionHeading align="center" eyebrow="ค่านิยม" title="สิ่งที่เราให้ความสำคัญ" />
      ...
      <section className="bg-orange-500 py-12">
        <Container size="wide" className="text-center">
          <h2 className="text-2xl font-bold text-white">มีคำถามเกี่ยวกับประกันภัย?</h2>
          <p className="mt-3 text-orange-50">เราพร้อมให้คำปรึกษาฟรี ไม่มีข้อผูกมัด</p>
