    ...
    <Container size="wide" className="py-4">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-navy-800">
          จัดการหน้าแผนประกันภัย (Products)
        </h1>
        <p className="text-sm text-navy-500 font-medium mt-1">
          แก้ไขรายละเอียดความคุ้มครอง เบี้ยประกัน เงื่อนไข
          และตารางเปรียบเทียบสำหรับแต่ละประเภทประกัน
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {pages.map((page) => (
          <Card
            key={page.id}
            className="bg-white border border-gray-200 overflow-hidden flex flex-col justify-between"
          >
            <div className="p-6">
              ...
              <div className="mt-4 border-t border-gray-100 pt-3">
                <span className="block text-xs font-bold text-navy-400">
                  ค่าเบี้ยเริ่มต้น
                </span>
