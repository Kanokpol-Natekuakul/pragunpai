    ...
    <Container size="wide" className="py-4">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-navy-800">
          จัดการแผนโบรชัวร์ประกันอุบัติเหตุ
        </h1>
        <p className="text-sm text-navy-500 font-medium mt-1">
          ปรับแต่งโหมดการแสดงแผนเปรียบเทียบในหน้า /accident-insurance
          และอัปโหลดโบรชัวร์รูปภาพ 1 แถว 3 รูป พร้อมฟังก์ชันคลิกขยายใหญ่
        </p>
      </div>
