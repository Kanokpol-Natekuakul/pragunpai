...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "คุ้มครองทรัพย์สินจากอัคคีภัย ภัยน้ำท่วม ขอใบเสนอราคาที่ Pragunpai",
    type: "article",
  },
};
...
const propertyTypes = [
  {
    ...
    items: [
      "ตัวบ้านและส่วนต่อเติม",
      "สิ่งของในบ้าน",
      "ความรับผิดต่อบุคคลที่ 3",
    ],
  },
  {
    icon: "🏢",
    title: "ประกันคอนโด",
    description:
      "คุ้มครองห้องชุดและทรัพย์สินในคอนโดจากอัคคีภัย น้ำท่วม และความเสียหาย",
  ...
  return (
    <>
      <Container size="wide" className="pt-6">
        <Breadcrumbs
          items={[
            { name: "ประกันบ้าน-คอนโด-หอพัก", href: "/property-insurance" },
          ]}
        />
      </Container>
        ...
        <section className="bg-linear-to-br from-navy-700 to-navy-900 py-16 text-white">
          <Container size="wide" className="text-center">
            ...
            <h1 className="mt-4 text-3xl font-bold sm:text-4xl">
              ประกันบ้าน คอนโด หอพัก
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-navy-100">
              คุ้มครองทรัพย์สินจากอัคคีภัย ภัยน้ำท่วม พายุ และการสูญหาย
              เลือกแผนที่เหมาะสม
            </p>
            {page.premium && (
      ...
      <section className="bg-white py-16">
        <Container size="prose">
          <div className="prose-thai">
            ...
            <p>
              <strong>ประกันทรัพย์สิน</strong> คุ้มครองบ้าน คอนโด หอพัก
              และทรัพย์สินภายใน จากความเสียหายที่เกิดจาก
              <strong> อัคคีภัย ฟ้าผ่า พายุ น้ำท่วม </strong>
      ...
      <section className="bg-navy-50 py-16">
        <Container size="wide">
          <SectionHeading
            eyebrow="ประเภทประกัน"
            title="เลือกประเภทที่เหมาะกับคุณ"
          />
