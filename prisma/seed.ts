  ...
  const insurancePages = [
    {
      ...
      coverage: "คุ้มครองค่ารักษาพยาบาลสูงสุด 80,000 บาท และทุนประกันกรณีเสียชีวิตสูงสุด 500,000 บาท",
      premium: "เริ่มต้น 645 บาท/ปี",
      conditions: "คุ้มครองผู้ประสบภัยจากรถทุกคน ไม่ว่าจะเป็นผู้ขับขี่ ผู้โดยสาร หรือคนเดินเท้า",
      pdfUrl: "/pdfs/brochure-car-act.pdf",
      seoTitle: "พ.ร.บ. ประกันภัยรถยนต์ — ขอใบเสนอราคา ต่อ พ.ร.บ. ง่าย",
      metaDescription: "พ.ร.บ. ประกันภัยรถยนต์ เป็นประกันภัยภาคบังคับตามกฎหมาย ครอบคลุมค่ารักษาพยาบาลและทุนประกันในกรณีเสียชีวิต ขอใบเสนอราคาและต่อ พ.ร.บ. ได้ที่ Pragunpai",
    ...
    },
    {
      ...
      summary: "ความคุ้มครองสำหรับเด็กแรกเกิดถึงผู้สูงอายุ เปรียบเทียบแผนและเลือกความคุ้มครองที่เหมาะสม",
      coverage: "คุ้มครองค่ารักษาพยาบาลจากอุบัติเหตุ เงินชดเชยรายได้ และทุนประกันกรณีเสียชีวิตจากอุบัติเหตุ",
      premium: "เริ่มต้น 1,000 บาท/ปี",
      conditions: "ผู้เอาประกันภัยต้องมีอายุระหว่าง 1-80 ปี (ขึ้นอยู่กับแผนประกัน)",
      pdfUrl: "/pdfs/brochure-accident.pdf",
      seoTitle: "ประกันอุบัติเหตุ — เปรียบเทียบแผน ครอบคลุมเด็กถึงผู้สูงอายุ",
      metaDescription: "ครอบคลุมเด็กแรกเกิดถึงผู้สูงอายุ เปรียบเทียบแผนและขอใบเสนอราคาได้ที่ Pragunpai",
      keywords: "ประกันอุบัติเหตุ, ประกันอุบัติเหตุส่วนบุคคล, ประกันอุบัติเหตุผู้สูงอายุ",
      published: true,
    },
    {
      id: "prod-property",
      ...
      summary: "คุ้มครองบ้านและสิ่งของในบ้านจากอัคคีภัย ภัยน้ำท่วม พายุ และการสูญหาย",
      coverage: "คุ้มครองตัวอาคารและสิ่งปลูกสร้าง ทรัพย์สินภายใน และความรับผิดต่อบุคคลภายนอก",
      premium: "เริ่มต้น 1,500 บาท/ปี",
      conditions: "สิ่งปลูกสร้างต้องเป็นคอนกรีตล้วนหรือครึ่งตึกครึ่งไม้ตามข้อกำหนด",
      pdfUrl: "/pdfs/brochure-property.pdf",
      seoTitle: "ประกันบ้าน คอนโด หอพัก — คุ้มครองทรัพย์สิน ขอใบเสนอราคา",
      metaDescription: "ประกันบ้าน ประกันคอนโด และประกันหอพัก คุ้มครองทรัพย์สินจากอัคคีภัย ภัยน้ำท่วม และการสูญหาย เปรียบเทียบแผนและขอใบเสนอราคาได้ที่ Pragunpai",
