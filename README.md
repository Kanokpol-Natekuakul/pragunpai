...
_แอดมินเริ่มต้น: `admin@pragunpai.com` / รหัสผ่าน: `ChangeMe123!` (กรุณาไปเปลี่ยนในระบบหลังบ้านทันที)_
...
_ระบบจะรันสคริปต์นี้ทุกวันเวลา 02:00 น. เพื่อทำการตรวจสอบคีย์ expiresAt ในฐานข้อมูล_
